...
#     # Realizar las consultas usando LangChain
#     respuestas = [
#         buscar_informacion_con_langchain(message.content, vectorstore_ubicaciones),
#         buscar_informacion_con_langchain(message.content, vectorstore_precios)
#     ]
    
#     # Combinar las respuestas
#     informacion_adicional = "\n".join(
#         [f"Información sobre {tipo}:\n{res['result']}" for tipo, res in zip(['ubicaciones', 'precios'], respuestas) if res]
#     )
...
#     respuesta = qa_chain.invoke(query)  # Usar invoke en lugar de run
#     return respuesta
